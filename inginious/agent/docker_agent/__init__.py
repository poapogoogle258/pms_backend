...
class DockerAgent(Agent):
    ...
    def __new_job_sync(self, message: BackendNewJob, future_results):
        ...
        course_id = message.course_id if message.course_id == 'compiler' else 'compiler' #PMS17-10
        task_id = message.task_id if message.course_id == 'compiler' else 'script' #PMS17-10
