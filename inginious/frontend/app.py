...
def get_app(config):
    ...
    if db_version is None:
        ...
        database.user_tasks.ensure_index([("username", pymongo.ASCENDING), ("courseid", pymongo.ASCENDING), ("taskid", pymongo.ASCENDING)],unique=False)
    ...
    # database.course.remove({'_id':'course1633001607.4084487teacher00'})



    # database.submissions.ensure_index([('coursesid',pymongo.ASCENDING),('taskid',pymongo.ASCENDING),('problemid',pymongo.ASCENDING)],unique=True)
    # database.user_tasks.ensure_index([('coursesid',pymongo.ASCENDING),('taskid',pymongo.ASCENDING),('problemid',pymongo.ASCENDING)],unique=True)
